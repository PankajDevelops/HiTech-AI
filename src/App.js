...
function App() {
  ...
  {
    text: "Hi, I am HiTech-AI, powered by ChatGPT. A State-of-the-art language model develop by MR. PANKAJ",
    isBot:true,
...
const handleQuery = async (e) => {
  ...
  return (
    ...
    <div className="upperSide">
     <div className="upperSideTop"><img src={gptLogo} alt="Logo" className="logo" /><span className="brand">HiTech-AI</span></div>
